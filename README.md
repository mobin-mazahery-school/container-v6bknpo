...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-v6bknpo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-v6bknpo.containers.anotherwebservice.com/
...
```
git clone git@github.com:mobin-mazahery-school/container-v6bknpo.git
cd container-v6bknpo
```
...
```
docker attach container-v6bknpo
```
